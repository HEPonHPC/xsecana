...
int main(int argc, char ** argv) {
    ...
    auto contents = Array::LinSpaced(nbins_and_uof,
                                     1,
                                     10) - 5.5;
    ...
    Hist hist(contents, bins, errors1, exposure1);
    Hist hist2(contents, bins, errors2, exposure2);
    ...
    auto loaded = Hist::LoadFrom(input, "hist");
